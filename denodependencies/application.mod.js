...
function createHttpExceptionBody1(msgOrBody, error, statusCode) {
...
class HttpException1 extends Error {
    response;
    status;
    message;
...
class BadGatewayException1 extends HttpException1 {
    constructor(message, error = "Bad Gateway"){
        super(createHttpExceptionBody1(message, error, Status.BadGateway), Status.BadGateway);
    }
}
class BadRequestException1 extends HttpException1 {
    constructor(message, error = "Bad Request"){
        super(createHttpExceptionBody1(message, error, Status.BadRequest), Status.BadRequest);
    }
}
class ConflictException1 extends HttpException1 {
    constructor(message, error = "Conflict"){
        super(createHttpExceptionBody1(message, error, Status.Conflict), Status.Conflict);
    }
}
class ForbiddenException1 extends HttpException1 {
    constructor(message, error = "Forbidden"){
        super(createHttpExceptionBody1(message, error, Status.Forbidden), Status.Forbidden);
    }
}
class GatewayTimeoutException1 extends HttpException1 {
    constructor(message, error = "Gateway Timeout"){
        super(createHttpExceptionBody1(message, error, Status.GatewayTimeout), Status.GatewayTimeout);
    }
}
class GoneException1 extends HttpException1 {
    constructor(message, error = "Gone"){
        super(createHttpExceptionBody1(message, error, Status.Gone), Status.Gone);
    }
}
class TeapotException1 extends HttpException1 {
    constructor(message, error = "Teapot"){
        super(createHttpExceptionBody1(message, error, Status.Teapot), Status.Teapot);
    }
}
class MethodNotAllowedException1 extends HttpException1 {
    constructor(message, error = "Method Not Allowed"){
        super(createHttpExceptionBody1(message, error, Status.MethodNotAllowed), Status.MethodNotAllowed);
    }
}
class NotAcceptableException1 extends HttpException1 {
    constructor(message, error = "Not Acceptable"){
        super(createHttpExceptionBody1(message, error, Status.NotAcceptable), Status.NotAcceptable);
    }
}
class NotFoundException1 extends HttpException1 {
    constructor(message, error = "Not Found"){
        super(createHttpExceptionBody1(message, error, Status.NotFound), Status.NotFound);
    }
}
class NotImplementedException1 extends HttpException1 {
    constructor(message, error = "Not Implemented"){
        super(createHttpExceptionBody1(message, error, Status.NotImplemented), Status.NotImplemented);
    }
}
class RequestEntityTooLargeException1 extends HttpException1 {
    constructor(message, error = "Request Entity Too Large"){
        super(createHttpExceptionBody1(message, error, Status.RequestEntityTooLarge), Status.RequestEntityTooLarge);
    }
}
class RequestTimeoutException1 extends HttpException1 {
    constructor(message, error = "Request Timeout"){
        super(createHttpExceptionBody1(message, error, Status.RequestTimeout), Status.RequestTimeout);
    }
}
class ServiceUnavailableException1 extends HttpException1 {
    constructor(message, error = "Service Unavailable"){
        super(createHttpExceptionBody1(message, error, Status.ServiceUnavailable), Status.ServiceUnavailable);
    }
}
class UnauthorizedException1 extends HttpException1 {
    constructor(message, error = "Unauthorized"){
        super(createHttpExceptionBody1(message, error, Status.Unauthorized), Status.Unauthorized);
    }
}
class UnprocessableEntityException1 extends HttpException1 {
    constructor(message, error = "Unprocessable Entity"){
        super(createHttpExceptionBody1(message, error, Status.UnprocessableEntity), Status.UnprocessableEntity);
    }
}
class InternalServerErrorException1 extends HttpException1 {
    constructor(message, error = "Internal Server Error"){
        super(createHttpExceptionBody1(message, error, Status.InternalServerError), Status.InternalServerError);
    }
}
class UnsupportedMediaTypeException1 extends HttpException1 {
    constructor(message, error = "Unsupported Media Type"){
        super(createHttpExceptionBody1(message, error, Status.UnsupportedMediaType), Status.UnsupportedMediaType);
    }
}
export { createHttpExceptionBody1 as createHttpExceptionBody };
export { HttpException1 as HttpException };
export { BadGatewayException1 as BadGatewayException };
export { BadRequestException1 as BadRequestException };
export { ConflictException1 as ConflictException };
export { ForbiddenException1 as ForbiddenException };
export { GatewayTimeoutException1 as GatewayTimeoutException };
export { GoneException1 as GoneException };
export { TeapotException1 as TeapotException };
export { MethodNotAllowedException1 as MethodNotAllowedException };
export { NotAcceptableException1 as NotAcceptableException };
export { NotFoundException1 as NotFoundException };
export { NotImplementedException1 as NotImplementedException };
export { RequestEntityTooLargeException1 as RequestEntityTooLargeException };
export { RequestTimeoutException1 as RequestTimeoutException };
export { ServiceUnavailableException1 as ServiceUnavailableException };
export { UnauthorizedException1 as UnauthorizedException };
export { UnprocessableEntityException1 as UnprocessableEntityException };
export { InternalServerErrorException1 as InternalServerErrorException };
export { UnsupportedMediaTypeException1 as UnsupportedMediaTypeException };
function contentType(filepath) {
    return mod3.DB[extname2(filepath)];
}
...
class Context1 {
    ...
    constructor(optionsOrContext){
        if (optionsOrContext instanceof Context1) {
    ...
    #writeContentType = (v)=>{
        if (!this.response.headers.has(mod2.ContentType)) {
            this.response.headers.set(mod2.ContentType, v);
        }
    };
    #readBody = async ()=>{
        const contentType = this.request.headers.get(mod2.ContentType);
        walk: {
            let data = {
            };
            if (contentType) {
                if (contentType.includes(mod3.ApplicationJSON)) {
                    data = JSON.parse(decoder1.decode(await readAll(this.request.body)));
                } else if (contentType.includes(mod3.ApplicationForm)) {
                    for (const [k, v] of new URLSearchParams(decoder1.decode(await readAll(this.request.body)))){
                        data[k] = v;
                    }
                } else if (contentType.includes(mod3.MultipartForm)) {
    ...
    string(v, code = Status.OK) {
        this.#writeContentType(mod3.TextPlainCharsetUTF8);
        this.response.status = code;
        this.response.body = encoder2.encode(v);
    }
    json(v, code = Status.OK) {
        this.#writeContentType(mod3.ApplicationJSONCharsetUTF8);
        this.response.status = code;
        this.response.body = encoder2.encode(typeof v === "object" ? JSON.stringify(v) : v);
    }
    html(v, code = Status.OK) {
        this.#writeContentType(mod3.TextHTMLCharsetUTF8);
        this.response.status = code;
        this.response.body = encoder2.encode(v);
    }
    htmlBlob(b, code = Status.OK) {
        this.blob(b, mod3.TextHTMLCharsetUTF8, code);
    }
    ...
    redirect(url, code = Status.Found) {
        this.response.headers.set(mod2.Location, url);
        this.response.status = code;
    }
}
class Node {
...
class Application1 {
    ...
    #transformResult = async (c, h)=>{
        ...
        try {
            ...
            if (e instanceof HttpException1) {
                result = c.json(typeof e.response === "object" ? e.response : createHttpExceptionBody1(e.response, undefined, e.status), e.status);
            } else {
                e = new InternalServerErrorException1(e.message);
